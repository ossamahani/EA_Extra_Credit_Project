package mum.ea.credit.week2.boot;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"mum.ea.credit.week2.controller", "mum.ea.credit.week2.domain",
			"mum.ea.credit.week2.dao", "mum.ea.credit.week2.service" })
@EnableJpaRepositories("mum.ea.credit.week2.dao")
